...
var DiffEditor = React.createClass({
    ...
    createInitialState: function (props) {
        ...
        var state = {
            leftState: props.left.state || editorStateFromText(props.left.initial),
            rightState: props.right.state || editorStateFromText(props.right.initial)
        };
    ...
    componentWillReceiveProps: function (props) {
        // New initial state ?
        if (props.left.initial !== this.props.left.initial
         || props.right.initial !== this.props.right.initial) {
